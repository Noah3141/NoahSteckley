...
function Navbar() {
    ...
    return (
        <nav
            className="navbar fs-5 fixed-top navbar-expand-lg bg-dark shadow-lg border-bottom border-info-subtle"
            data-bs-theme="dark"
        >
            <div className="container" style={{ height: "60px" }}>
                ...
                >
                    <ul className="navbar-nav me-auto pt-2 p-4 p-lg-1 mb-lg-0">
                        ...
                        >
                            ...
                            <ul className="dropdown-menu bg-info border border-dark border-2 fs-5">
                                ...
                                <Link className="dropdown-item text-primary" to="/articles/russian">
                                    Russian Language
                                </Link>
                                <Link
                                    className="dropdown-item text-primary"
                        ...
                        <li id="book-reviews-header" className="nav-item dropdown mx-lg-1">
                            <Link to="/book-reviews" className="nav-link text-light text-nowrap">
                                Book Reviews
                            </Link>
                        </li>
                    ...
                    <li className="nav-item dropdown ">
                        <Link
                            to="https://www.youtube.com/@NoahSteckley/videos"
                            target="_blank"
                            rel="noreferrer"
                            className="nav-link link-primary"
                        >
                    ...
                    <li className="nav-item radio text-light ps-lg-2">
                        ...
                        >
                            <input
                                ...
                                checked={true}
                            />
                            <label className="btn btn-outline-info text-dark" htmlFor="btnradio1">
                                <b>EN</b>
                            </label>
                            ...
                            <input
                                ...
                                autoComplete="off"
                            />
                            <label className="btn btn-outline-info text-dark" htmlFor="btnradio2">
                                <b>RU</b>
                            </label>
                        </div>
                    </li>
