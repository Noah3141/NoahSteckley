    ...
    const handleSubmit = async (event) => {
        ...
        function GPT3(userPrompt) {
            ...
            response.then((res) => {
                ...
                const engOutput = outputLine.split(" (")[1].replace("(", "").replace(")", "");
    ...
    return (
        <div className="container">
            ...
            <div className="alert alert-warning alert-dismissible fade show mt-4" role="alert">
                ...
                vocabulary lists from study material!
                <button
                    type="button"
                    className="btn-close"
            ...
            <div className="card bg-info border border-dark border-3 shadow p-4 mt-4">
                ...
                <p className="text-light card-footer pb-1 mb-0">
                    Keep in mind, this version of ChatGPT is not terribly good at Russian grammar.
                    While it provides good example sentences, they tend to contain grammatical
                    errors in case, gender, number etc.!
                </p>
            </div>
        </div>
    );
