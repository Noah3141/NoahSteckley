        ...
        <div className="row">
          <div className=" col-lg-6">
            <div className="card shadow my-4 p-4 mx-auto bg-light border border-dark border-1">
              ...
              <div className="card-body">
                A Russian club poster intended to stand out from other
                University club posters, catch the eye of those interested in
                Russian, but not make the poster inaccessible to those who don't
                speak it
              </div>
            </div>
          </div>
          ...
          <div className="  col-lg-6">
            <div className="card shadow my-4 p-4 mx-3 bg-dark border border-success border-1">
              ...
              <div className="card-body text-light">
                An infographic for teaching a novel Russian verb model, "verbs
                as trees"
              </div>
            </div>
          </div>
          ...
          <div className="  col-lg-12">
            <div className="card shadow my-4 p-4 mx-2 bg-dark border border-success border-1">
              ...
              <div className="card-body text-light">
                ...
                stories, and have been referred to as "desires" or "wishes."
                Many of these are adaptive, functional, and successfully
                fulfilled, and are therefore invisible. Those that "stick out" —
                plans/desires which are nascent and undeveloped — and are
                discordant with the integrity of a person's explicit aims are
                deemed a "complex." Thus, jealousy which a person is pretending
                doesn't exist, and is avoiding thinking about, because they hold
                the aim of not being jealous (perhaps because of a rigid ethic,
                or perhaps due to the allegedly unseemly implications of that
                jealousy), that jealousy is of course represented at various
                levels of the mind and body, and so, is liable to cause fumbled
                actions, slips of the tongue, the emotion itself, and
                spontaneous "noticings" of things related to the topic. Most
                importantly, what effects the jealousy has on the personality
                ...
                with the envied, and a strengthened faith in oneself. These
                would be the products of integrating the "complex," most
                effectively done through honest, dialogic, exploratory exposure
                to the envied.
              </div>
            </div>
          </div>
