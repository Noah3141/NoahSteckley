...
function KetosisPsychiatry() {
    return (
        <>
            <div className="container bg-light shadow rounded p-4 text-dark rounded-3 mb-4 pb-4">
                <iframe
                    width="100%"
                    height="600"
                    src="https://www.youtube.com/embed/BUtwr_6sFw4"
            ...
            <div className="container bg-light shadow rounded px-5 text-dark rounded-3 mb-4 pb-4">
                ...
                <h3>A Meta Review</h3>
                <p className="">
                    Research reviews published since 2021 were collected using Google Scholar. The
                    prompt "Ketogenic Diets as a Psychiatric Intervention" garnered "about 1800"
                    results. Of these, the first XX were parsed into the snippets below. All studies
                    from the search are included (even if they are off-topic), in the order they
                    appeared in the search. The parsing of these articles sometimes decontextualized
                    statements which in the original context may have read as more or less
                    problematic, but the effect of this on hypothesis-primacy should be washed out
                    by comparatively invariable themes within the literature.
                </p>
            </div>
